       ...
       <div className="resto-slider">
        ...
        <div className="resto-body">
          ...
          <section className="hours">
            <h2>Hours</h2>
            <ul>
              <li><i className="fa fa-clock-o"></i> Breakfast: 7:00 am - 11:00 am (daily)</li>
              <li><i className="fa fa-clock-o"></i> Lunch: 12:00 noon - 2:00 pm (daily)</li>
              <li><i className="fa fa-clock-o"></i> Dinner: open from 6:30 pm, last order at 10:00 pm (daily)</li>
            </ul>
          </section>
